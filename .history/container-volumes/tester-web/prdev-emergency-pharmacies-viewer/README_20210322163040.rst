...
Update Hinweise
----------------
Bitte sichern sie Dateien folgende Dateien styles.css und index.php falls sie daran Änderungen vornehmen oder legen Sie Kopien an, diese werden bei einem Update überschrieben.
